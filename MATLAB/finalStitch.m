...
for n = 1:(numToStitch-1)
 ...
 H12 = load('H1'); H12 = H12.H; % Homography of im1 to im2
 H23 = load('H2'); H23 = H23.H; % Homography of im3 to im2
 H34 = load('H3'); H34 = H34.H; % Homography of im1 to im2
 H54 = load('H4'); H54 = H54.H; % Homography of im3 to im2
 H65 = load('H5'); H65 = H65.H; % Homography of im1 to im2
 H76 = load('H6'); H76 = H76.H; % Homography of im3 to im2
...
HxArray = [HxArray, HArray{(size(HArray, 2)/2)}];
HxArray2 = [HArray{(size(HArray, 2)/2)+1}, HxArray2];
